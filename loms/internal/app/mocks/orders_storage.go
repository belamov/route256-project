...
func (m *MockOrdersStorage) GetOrderByOrderId(arg0 context.Context, arg1 int64) (models.Order, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOrdersStorageMockRecorder) GetOrderByOrderId(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetOrderByOrderId", reflect.TypeOf((*MockOrdersStorage)(nil).GetOrderByOrderId), arg0, arg1)
}
